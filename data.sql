...
-- employees
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Coop Mullinger', 'manager', 0, NULL, 94920023, 64218576, 96935140);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Barbie Fallow', 'manager', 2, NULL, 92748241, 64693711, 64493764);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Hermy Arnowitz', 'manager', 3, NULL, 80663610, 96195748, 98909272);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Guenna Tremathick', 'manager', 4, NULL, 98784479, 35063121, 78588192);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Joelly Ghiraldi', 'manager', 5, NULL, 99041669, 61677113, 62747916);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Analise Cromblehome', 'manager', 6, NULL, 96276127, 68771184, 68969601);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Bay Asplin', 'manager', 7, NULL, 95329756, 66961385, 86405138);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Jerri Spring', 'manager', 8, '3/11/2021'::DATE, 84554702, 98799575, 95932875);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Edan Jerrom', 'manager', 9, NULL, 91188079, 82869860, 60472197);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Ivor Calderhead', 'senior', 0, NULL, 94504347, 85211040, 88156728);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Adham Polet', 'senior', 1, NULL, 94578916, 92525122, 95737669);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Farand Sheryne', 'senior', 2, '4/11/2021'::DATE, 98053207, 66218482, 68338237);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Glenn Gartshore', 'senior', 3, NULL, 86362038, 68061849, 82644627);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Calhoun Minchinton', 'senior', 4, NULL, 64851417, 96160896, 62918111);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Ramona Destouche', 'senior', 5, NULL, 951229314, 81364989, 97410630);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Lishe Gorick', 'senior', 6, NULL, 63310585, 64092572, 93294488);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Efrem Stockoe', 'senior', 8, NULL, 69239146, 65381250, 69950238);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Wally Pourveer', 'senior', 9, NULL, 98594662, 68417912, 61490192);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Lindi Prenty', 'junior', 0, NULL, 85200268, 93575779, 98570855);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Krista Breadon', 'junior', 2, NULL, 66522307, 64229534, 60510044);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Iormina Sample', 'junior', 3, NULL, 82555227, 87930030, 66786751);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Charissa Krug', 'junior', 5, NULL, 63336739, 98528492, 62710525);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Giacopo Gutman', 'junior', 7, NULL, 82245680, 90684078, 80291358);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Humfried Gouinlock', 'junior', 8, NULL, 87940278, 84715982, 64735287);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Dara Palmby', 'junior', 9, NULL, 91126497, 68664237, 65158509);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Wynn Martellini', 'manager', 0, NULL, 82513326, 98523205, 64358934);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Lothario Greenstead', 'manager', 1, NULL, 85529803, 84720460, 61796222);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Delores Kohlerman', 'manager', 2, NULL, 81944593, 85460506, 99042489);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Forest Gatfield', 'manager', 3, NULL, 82401646, 82214225, 62224522);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Karalynn Badger', 'manager', 4, NULL, 94343297, 86518095, 82756113);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Bess Barczewski', 'manager', 5, NULL, 87839158, 83669298, 97306793);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Ethel Dominik', 'manager', 6, '2/11/2021'::DATE, 98200751, 87484084, 63531198);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Husain Engledow', 'manager', 7, NULL, 96159840, 87458340, 68387949);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Xylina Passfield', 'manager', 8, NULL, 87825459, 95739378, 67784763);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Miranda Siemon', 'manager', 9, NULL, 99078398, 83667592, 93670533);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Donna Bice', 'senior', 1, NULL, 81346343, 91139952, 61380468);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Margret Spinas', 'senior', 2, NULL, 94271540, 83143328, 86325932);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Jimmy Finby', 'senior', 3, '8/11/2021'::DATE, 98897753, 80235069, 62854872);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Janis Finder', 'senior', 4, NULL, 98639400, 94488661, 61682693);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Nani Vickar', 'senior', 5, NULL, 82754927, 92874691, 68062906);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Cyndi Gaspard', 'senior', 6, NULL, 81034385, 83315737, 68954518);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Egbert Pitbladdo', 'junior', 3, NULL, 91249613, 81100976, 62489773);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Ramsay Faloon', 'junior', 4, NULL, 99265932, 68308721, 65577271);
...
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Boonie Sloey', 'junior', 6, '3/11/2021'::DATE, 62481987, 96977726, 63123012);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Tally Roalfe', 'junior', 7, NULL, 98162544, 99422453, 63383206);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Demetria Kohrt', 'junior', 8, NULL, 95247869, 92277721, 60457080);
INSERT INTO employees (ename, ekind, did, resigned_date, mobile_contact, home_contact, office_contact) VALUES ('Brandi Graine', 'junior', 9, '2/11/2021'::DATE, 84309796, 87192061, 62082226);
