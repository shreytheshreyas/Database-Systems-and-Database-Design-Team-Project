...
SELECT * FROM view_booking_report('8/11/2021', 14);

-- returns 14's unapproved 1-hour meeting starting on 12/11/2021 1600
SELECT * FROM view_booking_report('9/11/2021', 14);

-- junior employee, returns empty table
SELECT * FROM view_booking_report('9/11/2021', 23);
...
SELECT * FROM view_booking_report('1/11/2021', 2);
